...
The question for the modeler should be, ``Does including this covariate improve the model for the purpose?''  There are times when it's best to leave a covariate out of a model
