...
Your students will be able to learn about statistical models, and build many models relevant to their topics of interest, using {\em just linear combinations}.
