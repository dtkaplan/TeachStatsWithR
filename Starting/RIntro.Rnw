...
<<iris-dotPlot-condA,cache=TRUE,fig.width=7.0,fig.height=4,out.width=".7\\textwidth",eval=FALSE>>=
...
<<mosaic3,fig.width=6,fig.height=2.5,eval=FALSE>>=
mosaic(mycrosstable)
@
...
<<"function-syntax-template",eval=FALSE>>=
functionname( argument1, argument2, ... )
@
\vspace{-5mm}
\begin{itemize}
