...
on Teaching Statistics and reused for the 2013 USCOTS.  
...
\Caution{Despite your best efforts, you WILL find bugs both in this document and in our code.
...
and loaded separately. The \pkg{mosaic} (and its dependencies) will be used throughout.  
...
For beginners, we introduce \pkg{knitr} with RMardown,
...
such as teh USCOTS 2011 and 2013 workshops on 
