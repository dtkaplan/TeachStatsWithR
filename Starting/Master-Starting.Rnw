...
\hspace{2cm}\parbox{8in}{\tableofcontents}
...
<<child='RForStudents.Rnw', eval=includeChapter>>=
@

<<child='RForInstructors.Rnw', eval=includeChapter>>=
@
...
<<child='Manipulate.Rnw', eval=includeChapter>>=
@
